...
export default function SeatCounter({ isPulsing = false }: SeatCounterProps) {
  ...
  return (
    <div className={`relative group cursor-pointer transition-all duration-300 ${isPulsing ? 'scale-105' : ''}`}>
      ...
      {/* Main badge */}
      <div className="relative inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-amber-500 to-amber-600 text-black font-bold text-sm shadow-2xl">
        {/* Live indicator */}
